				       ...
				       struct vcpu_reset_state *reset_state)
{
	...
	*vcpu_pc(vcpu) = target_pc;
	...
	/*
	 * We may come from a state where either a PC update was pending (SMC
	 * call resulting in PC being incremented to skip the SMC) or a pending
	 * exception. Make sure we get rid of all that, as this cannot be valid
	 * out of reset.
	 *
	 * Note that clearing the exception mask also clears PC updates, but
	 * that's an implementation detail, and we really want to make it
	 * explicit.
	 */
