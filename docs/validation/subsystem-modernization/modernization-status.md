...
| Camera | `.061` | `.073` | Audit proceeds from the exact Graphics-qualified baseline; default is defer unless a bounded kernel-only fix is proven | NOT STARTED | NOT TESTED | AUDITING |
